...
public final class CandleParser {
     ...
     * @throws HypeError 当返回不是数组或元素解析失败时抛出自定义错误
     */
//    public static List<Candle> parseList(JsonNode node) throws HypeError {
//        if (node == null || !node.isArray()) {
//            throw new HypeError("Candle 列表解析失败：返回不是数组或为空");
//        }
...
//            }
//            try {
//                Candle c = JSONUtil.treeToValue(e, Candle.class);
//                result.add(c);
//            } catch (Exception ex) {
//                throw new HypeError("Candle 反序列化失败（索引=" + i + "): " + ex.getMessage());
//            }
//        }
//        return result;
//    }
...
//     * @throws HypeError 当返回不是数组或元素解析失败时抛出自定义错误
//     */
//    public static Optional<Candle> parseLatest(JsonNode node) throws HypeError {
